...
def generate_response_node(state: TicketState) -> TicketState:
    ...
    **Guidelines**  
    ...
    - If context lacks answer, state that honestly and proactively escalate (e.g., "I've escalated this to [team]").  
    - For high urgency (payment delays, lockouts), show empathy and escalate if no clear fix.  
    - For troubleshooting steps, include them from context; add: "If the issue persists, reply and I'll escalate."  
